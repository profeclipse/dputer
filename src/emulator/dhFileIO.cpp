...
void dhFileIO::handleControl(uint8_t cmd, uint8_t datalo, uint8_t datahi,
...
void dhFileIO::doSeek(uint8_t fd, uint8_t datalo, uint8_t datahi,
...
void dhFileIO::doResize(uint8_t fd, uint8_t datalo, uint8_t datahi,
                        uint8_t datalo2, uint8_t datahi2) {
  FILE *f = fdToFile(fd);
  off_t pos = 0;
  int r = 0;
