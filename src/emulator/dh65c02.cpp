...
uint16_t dh65c02::modeIMM() {
  return PC++;
}

uint16_t dh65c02::modeIMP() {
  return 0;
}
...
uint16_t dh65c02::modeZPG() {
  return read(PC++);
}

uint16_t dh65c02::modeZPX() {
  return (read(PC++) + X) & 0xFF;
}

uint16_t dh65c02::modeZPY() {
...
void dh65c02::opSTP(uint16_t src) {
  halted = true;
}
...
void dh65c02::opSTA(uint16_t src) {
  write(src,A);
}

void dh65c02::opSTX(uint16_t src) {
  write(src,X);
}

void dh65c02::opSTY(uint16_t src) {
  write(src,Y);
}
...
void dh65c02::opTXS(uint16_t src) {
  SP = X;
}
...
void dh65c02::opPHA(uint16_t src) {
  push(A);
}

void dh65c02::opPHP(uint16_t src) {
  push(PS|uF|BF);
}
...
void dh65c02::opCLC(uint16_t src) {
  setFlag(CF,false);
}

void dh65c02::opCLD(uint16_t src) {
  setFlag(DF,false);
}

void dh65c02::opCLI(uint16_t src) {
  setFlag(IF,false);
}

void dh65c02::opCLV(uint16_t src) {
  setFlag(VF,false);
}

void dh65c02::opSEC(uint16_t src) {
  setFlag(CF,true);
}

void dh65c02::opSED(uint16_t src) {
  setFlag(DF,true);
}

void dh65c02::opSEI(uint16_t src) {
  setFlag(IF,true);
}
...
void dh65c02::opJMP(uint16_t src) {
  PC = src;
}
...
void dh65c02::opRTS(uint16_t src) {
  PC = popWord() + 1;
}
...
void dh65c02::opPHX(uint16_t src) {
  push(X);
}

void dh65c02::opPHY(uint16_t src) {
  push(Y);
}
...
void dh65c02::opSTZ(uint16_t src) {
  write(src,0);
}
...
void dh65c02::opWAI(uint16_t src) {
  waiting = true;
}
